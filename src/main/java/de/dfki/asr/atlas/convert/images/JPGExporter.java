...
@AtlasExporter(contentType = "image/jpg", fileExtension = ".jpg", folderTypes = {"diffuse", "specular", "ambient", "emissive",
	"displacement", "height", "lightmap", "normals", "opacity", "reflection", "shininess"})
public class JPGExporter implements ExportOperation<InputStream> {
	...
	public boolean canExportFolder(Folder folder) {
		...
		return mimetype != null && mimetype.equals("image/jpg");
	}
